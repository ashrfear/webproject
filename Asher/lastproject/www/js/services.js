...
.factory('fireBaseData', function($firebase) {
	var ref = new Firebase("https://asher-e002d.firebaseio.com/"),
    refCart = new Firebase("https://asher-e002d.firebaseio.com/cart"),
    refUser = new Firebase("https://asher-e002d.firebaseio.com/users"),
    refCategory = new Firebase("https://asher-e002d.firebaseio.com/category"),
    refOrder = new Firebase("https://asher-e002d.firebaseio.com/orders"),
    refFeatured = new Firebase("https://asher-e002d.firebaseio.com/featured"),
    refMenu = new Firebase("https://asher-e002d.firebaseio.com/menu");
  return {
    ref: function() {
      return ref;
    },
